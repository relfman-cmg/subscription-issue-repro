...
4. Subscribe through the gateway, over either transport:
   - WebSocket: `ws://127.0.0.1:5310/graphql`
   - SSE: `POST http://127.0.0.1:5310/graphql` with `Accept: text/event-stream`
